    ...
    (async () => {
      ...
      try {
        ...
        if (atribute === 'audio') {
          ...
          this.container.querySelector('.footer').insertAdjacentElement('afterbegin', box);
        ...
        this.container.querySelector('.record').addEventListener('click', (event) => {
          if (event.target.classList.contains('stop')) {
            ...
            this.container.querySelector('.actions').classList.remove('hidden');
            this.getPosition();
